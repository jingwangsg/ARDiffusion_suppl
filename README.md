...
## Streaming T2V Quality comparison
### Streaming T2V
<div style="display: flex; justify-content: space-between;">
  <video width="30%" controls>
    <source src="assets/streamt2v/A_baseball_player_swings_his_bat_in_a_large_motion_arc,_hitting_a_home_run._03_11_02_566602.mp4" type="video/mp4">
  </video>
  <video width="30%" controls>
    <source src="assets/streamt2v/A_little_girl_stands_in_a_park,_holding_out_her_hand_as_she_feeds_a_flock_of_colorful_birds_flutteri_03_11_06_784920.mp4" type="video/mp4">
  </video>
    <video width="30%" controls>
    <source src="assets/streamt2v/a_monkey_eating_a_pizza_in_central_park,_GoPro_film_style_03_11_08_015129.mp4" type="video/mp4">
  </video>
</div>
...
<div style="display: flex; justify-content: space-between;">
  <video width="48%" controls>
    <source src="assets/fifo/a_busy_bakery_filled_with.mp4" type="video/mp4">
  </video>
  <video width="48%" controls>
    <source src="assets/fifo/a_cat_on_the_left_of_a_bus.mp4" type="video/mp4">
  </video>
</div>
...
<div style="display: flex; justify-content: space-between;">
  <video width="48%" controls>
    <source src="assets/outpaint/A_beautiful_mosque_stands_tall_in_the_city_center.mp4" type="video/mp4">
  </video>
  <video width="48%" controls>
    <source src="assets/outpaint/a_family.mp4" type="video/mp4">
  </video>
</div>

<center><div style="width: 800px; text-align: left;"><b>Fig 5. Video generated by FIFO Diffusion, Outpainting and Streaming T2V.</b> Streaming T2V is generally subpar w.r.t object consistency, motion stability and visual quality. </div></center>
